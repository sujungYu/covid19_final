...
<div>
    <div class="map-wrapper">
      <GyeonggiCnt></GyeonggiCnt>
      <GyeonggiBtn></GyeonggiBtn>
      </div>
</div>
...
import GyeonggiCnt from '../mapcnts/gyeonggicnt.vue'
import GyeonggiBtn from '../buttons/gyeonggibtn.vue'
export default {
    ...
    methods: {
      draw() {
        ...
        const xoffset = width / 2.2 - scale * (bounds[1][0] + bounds[0][0]) / 2 + 10;
        const yoffset = height / 2.7 - scale * (bounds[1][1] + bounds[0][1]) / 2 + 80;
