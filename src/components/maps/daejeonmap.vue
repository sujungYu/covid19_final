...
<div>
    <div class="map-wrapper">
      <DaejeonCnt></DaejeonCnt>
      <DaejeonBtn></DaejeonBtn>
      </div>
</div>
...
import DaejeonCnt from '../mapcnts/daejeoncnt.vue'
import DaejeonBtn from '../buttons/daejeonbtn.vue'
export default {
    ...
    methods: {
      draw() {
        ...
        const yoffset = height / 2.6 - scale * (bounds[1][1] + bounds[0][1]) / 2 + 80;
